<template>
  <Teleport to="body">
    ...
    >
      <main
        class="text-white w-full max-w-[30rem] bg-mainbg_600 flex flex-col text-center border border-white border-b-0 p-4 relative rounded-xl font-medium min-h-60"
      >
        <button
